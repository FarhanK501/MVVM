...
class NotesMenuFactory @Inject constructor() {

	fun getListOfMenus(): List<MenuModel> {
		val menus = arrayListOf<MenuModel>()
		menus.add(MenuModel(android.R.drawable.presence_audio_online, NotesMenu.AUDIO.menuName))
		...
		menus.add(MenuModel(android.R.drawable.ic_menu_help, NotesMenu.ABOUT_APP.menuName))
		return menus
	}
}